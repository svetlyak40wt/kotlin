...
/**
 * Provides a sliding window on the original collection. The sliding window is represented by a sequence of sub lists.
...
/**
 * Provides a sliding window on the original list from the end to the beginning.
