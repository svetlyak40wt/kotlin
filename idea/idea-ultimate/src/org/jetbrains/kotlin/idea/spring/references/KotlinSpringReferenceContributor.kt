...
class KotlinSpringReferenceContributor : AbstractKotlinReferenceContributor() {
    override fun registerReferenceProviders(registrar: PsiReferenceRegistrar) {
        registrar.registerProvider(KtStringTemplateExpression::class.java) {
        ...
        registrar.registerProvider(KtStringTemplateExpression::class.java, PsiReferenceRegistrar.HIGHER_PRIORITY) {
            if (!it.isPlain()) return@registerProvider null
        ...
        registrar.registerMultiProvider(KtStringTemplateExpression::class.java) {
