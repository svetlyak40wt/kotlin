...
public class InlineCodegen extends CallGenerator {
    ...
    private InlineCallSiteInfo getInlineCallSiteInfo() {
        ...
        JvmMethodSignature signature = typeMapper.mapSignature(context.getFunctionDescriptor(), context.getContextKind(), true);
    ...
    private SMAPAndMethodNode generateLambdaBody(LambdaInfo info) {
        ...
        JvmMethodSignature jvmMethodSignature = typeMapper.mapSignature(descriptor, true);
