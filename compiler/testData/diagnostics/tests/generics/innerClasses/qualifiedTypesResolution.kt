...
fun error1(): Outer<A>.Inner<B>.Inner3<!WRONG_NUMBER_OF_TYPE_ARGUMENTS_FOR_CLASS!><C, D><!> = null!!
fun error2(): Outer<A>.Inner<!WRONG_NUMBER_OF_TYPE_ARGUMENTS_FOR_CLASS!><B, C, D><!>.Inner2 = null!!
fun error3(): <!WRONG_NUMBER_OF_TYPE_ARGUMENTS_FOR_CLASS!>Outer<!>.Inner<A, B>.Inner3<C> = null!!
...
fun error6(): Outer.Obj<!WRONG_NUMBER_OF_TYPE_ARGUMENTS_FOR_CLASS!><A><!>.Nested2<B>.Inner5<C> = null!!
