...
fun test() {
    ...
    Foo<String>.<!WRONG_NUMBER_OF_TYPE_ARGUMENTS_FOR_CLASS!>Bar<!>::class
    Foo<!TYPE_ARGUMENTS_FOR_OUTER_CLASS_WHEN_NESTED_REFERENCED!><String><!>.Bar.Baz::class

    a<Foo<String>.<!WRONG_NUMBER_OF_TYPE_ARGUMENTS_FOR_CLASS!>Bar<!>>()
...
fun Foo<String>.<!WRONG_NUMBER_OF_TYPE_ARGUMENTS_FOR_CLASS!>Bar<!>.ext() {}
