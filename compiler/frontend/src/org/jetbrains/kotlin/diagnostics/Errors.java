...
public interface Errors {
    ...
    DiagnosticFactory2<KtElement, Integer, ClassDescriptor> WRONG_NUMBER_OF_TYPE_ARGUMENTS_FOR_CLASS = DiagnosticFactory2.create(ERROR);
    DiagnosticFactory2<KtElement, Integer, CallableDescriptor> WRONG_NUMBER_OF_TYPE_ARGUMENTS_FOR_CALL = DiagnosticFactory2.create(ERROR);
